...
import com.tony.wifip2p.view.ProgressDialog;
 ...
 */
public class ReceiveFileActivity extends BaseActivity implements SocketEventListener, View.OnClickListener {
     ...
     * 发送消息
     */
    public void sengdMsg(View view) {

        if (mBinder!=null){

            mBinder.sendMsg("send msg to client socket ");
        }
    }
    /**
     * 创建组群，等待连接
